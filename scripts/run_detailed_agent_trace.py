...
def main() -> None:
    ...
    parser.add_argument("--orc-base-url", default="http://localhost:8002/v1")
    parser.add_argument("--vra-base-url", default="http://localhost:8001/v1")
    parser.add_argument("--ga-base-url", default="http://localhost:8002/v1")
    parser.add_argument("--pa-base-url", default="http://localhost:8002/v1")
